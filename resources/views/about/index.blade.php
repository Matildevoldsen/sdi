...
@section('stylesheets')
    ...
    <style type="text/css">
        ...
        body::before {
            ...
            right: 0;
            position: absolute;
            background: url('storage/thumbnail/{{ $about->bg }}') center center no-repeat;
        ...
        .section-about .profile-title_t span {
            font-weight: 300;
        }
        ...
        @media (max-width: 767px) {
            ...
            .profile-list .title_t, .profile-list .cont {
                width: 100%;
                float: none;
                line-height: 1.2;
            }
